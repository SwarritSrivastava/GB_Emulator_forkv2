...
\hypertarget{build_2__deps_2googletest-src_2googletest_2include_2gtest_2internal_2gtest-type-util_8h_source}{}\label{build_2__deps_2googletest-src_2googletest_2include_2gtest_2internal_2gtest-type-util_8h_source}\index{build/\_deps/googletest-\/src/googletest/include/gtest/internal/gtest-\/type-\/util.h@{build/\_deps/googletest-\/src/googletest/include/gtest/internal/gtest-\/type-\/util.h}}
...
\DoxyCodeLine{00138\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1None}{None}}\ \{\};}
\DoxyCodeLine{00139\ }
...
\DoxyCodeLine{00153\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1TemplateSel}{TemplateSel}}\ \{}
\DoxyCodeLine{00154\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00155\ \ \ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1TemplateSel_1_1Bind}{Bind}}\ \{}
...
\DoxyCodeLine{00163\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1Templates}{Templates}}\ \{}
\DoxyCodeLine{00164\ \ \ \textcolor{keyword}{using\ }Head\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1TemplateSel}{TemplateSel<Head\_>}};}
\DoxyCodeLine{00165\ \ \ \textcolor{keyword}{using\ }Tail\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1Templates}{Templates}}<Tail\_...>;}
\DoxyCodeLine{00166\ \};}
\DoxyCodeLine{00167\ }
\DoxyCodeLine{00168\ \textcolor{keyword}{template}\ <GTEST\_TEMPLATE\_\ Head\_>}
\DoxyCodeLine{00169\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1Templates}{Templates}}<Head\_>\ \{}
\DoxyCodeLine{00170\ \ \ \textcolor{keyword}{using\ }Head\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1TemplateSel}{TemplateSel<Head\_>}};}
\DoxyCodeLine{00171\ \ \ \textcolor{keyword}{using\ }Tail\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1None}{None}};}
\DoxyCodeLine{00172\ \};}
\DoxyCodeLine{00173\ }
...
\DoxyCodeLine{00176\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1Types}{Types}}\ \{}
\DoxyCodeLine{00177\ \ \ \textcolor{keyword}{using\ }Head\ =\ Head\_;}
\DoxyCodeLine{00178\ \ \ \textcolor{keyword}{using\ }Tail\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1Types}{Types}}<Tail\_...>;}
\DoxyCodeLine{00179\ \};}
\DoxyCodeLine{00180\ }
\DoxyCodeLine{00181\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Head\_>}
\DoxyCodeLine{00182\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1Types}{Types}}<Head\_>\ \{}
\DoxyCodeLine{00183\ \ \ \textcolor{keyword}{using\ }Head\ =\ Head\_;}
\DoxyCodeLine{00184\ \ \ \textcolor{keyword}{using\ }Tail\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1None}{None}};}
\DoxyCodeLine{00185\ \};}
\DoxyCodeLine{00186\ }
...
\DoxyCodeLine{00190\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1ProxyTypeList}{ProxyTypeList}}\ \{}
\DoxyCodeLine{00191\ \ \ \textcolor{keyword}{using\ }type\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1Types}{Types}}<Ts...>;}
\DoxyCodeLine{00192\ \};}
\DoxyCodeLine{00193\ }
\DoxyCodeLine{00194\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}>}
\DoxyCodeLine{00195\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1is__proxy__type__list}{is\_proxy\_type\_list}}\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00196\ }
\DoxyCodeLine{00197\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ Ts>}
\DoxyCodeLine{00198\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1is__proxy__type__list}{is\_proxy\_type\_list}}<\doxymbox{\hyperlink{structtesting_1_1internal_1_1ProxyTypeList}{ProxyTypeList}}<Ts...>>\ :\ std::true\_type\ \{\};}
\DoxyCodeLine{00199\ }
...
\DoxyCodeLine{00204\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1GenerateTypeList}{GenerateTypeList}}\ \{}
...
\DoxyCodeLine{00207\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{structtesting_1_1internal_1_1ProxyTypeList}{ProxyTypeList<T>}}>::type;}
\DoxyCodeLine{00208\ }
...
\DoxyCodeLine{00216\ \textcolor{keyword}{using\ }Types\ =\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1ProxyTypeList}{internal::ProxyTypeList}}<Ts...>;}
\DoxyCodeLine{00217\ }
