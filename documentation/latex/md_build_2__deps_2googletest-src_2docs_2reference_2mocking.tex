...
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking}{}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking}\index{Mocking Reference@{Mocking Reference}}
\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md259}%
\Hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md259}%


This page lists the facilities provided by Google\+Test for creating and working with mock objects. To use them, include the header {\ttfamily gmock/\+gmock.\+h}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_macros}{}\doxysection{\texorpdfstring{Macros}{Macros}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_macros}
...
See details for each modifier clause below.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md260}{}\doxysubsubsection{\texorpdfstring{With \{\+\#\+EXPECT\+\_\+\+CALL.\+With\}}{With \{\+\#\+EXPECT\+\_\+\+CALL.\+With\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md260}
...
Google\+Test passes all of the arguments as one tuple into the matcher. The parameter {\itshape {\ttfamily multi\+\_\+argument\+\_\+matcher}} must thus be a matcher of type {\ttfamily \doxylink{classMatcher}{Matcher}\texorpdfstring{$<$}{<}std::\+tuple\texorpdfstring{$<$}{<}A1, ..., An\texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>}}, where {\ttfamily A1, ..., An} are the types of the function arguments.
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md261}{}\doxysubsubsection{\texorpdfstring{Times \{\+\#\+EXPECT\+\_\+\+CALL.\+Times\}}{Times \{\+\#\+EXPECT\+\_\+\+CALL.\+Times\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md261}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md262}{}\doxysubsubsection{\texorpdfstring{In\+Sequence \{\+\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}{In\+Sequence \{\+\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md262}
...
See also the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}{\`{}\+In\+Sequence\`{} class}{2}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md263}{}\doxysubsubsection{\texorpdfstring{After \{\+\#\+EXPECT\+\_\+\+CALL.\+After\}}{After \{\+\#\+EXPECT\+\_\+\+CALL.\+After\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md263}
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md264}{}\doxysubsubsection{\texorpdfstring{Will\+Once \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}{Will\+Once \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md264}
...
The parameter {\itshape {\ttfamily action}} represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{action}} that the function call will perform. See the \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2actions}{Actions Reference}{0} for a list of built-\/in actions.
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/\+or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}{}\doxysubsubsection{\texorpdfstring{Will\+Repeatedly \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}{Will\+Repeatedly \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md266}{}\doxysubsubsection{\texorpdfstring{Retires\+On\+Saturation \{\+\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}{Retires\+On\+Saturation \{\+\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md266}
...
The parameter {\itshape {\ttfamily matchers...}} is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{matchers}} that correspond to each argument of the method {\itshape {\ttfamily method\+\_\+name}}. The {\ttfamily ON\+\_\+\+CALL} specification will apply only to calls of {\itshape {\ttfamily method\+\_\+name}} whose arguments match all of the matchers. If {\ttfamily (}\texorpdfstring{$\ast$}{*}{\ttfamily matchers...}\texorpdfstring{$\ast$}{*}{\ttfamily )} is omitted, the behavior is as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{wildcard matcher ({\ttfamily \+\_\+})}}. See the \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2matchers}{Matchers Reference}{0} for a list of all built-\/in matchers.
...
See details for each modifier clause below.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}{}\doxysubsubsection{\texorpdfstring{With \{\+\#\+ON\+\_\+\+CALL.\+With\}}{With \{\+\#\+ON\+\_\+\+CALL.\+With\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}
{\ttfamily .With(}\texorpdfstring{$\ast$}{*}{\ttfamily multi\+\_\+argument\+\_\+matcher}\texorpdfstring{$\ast$}{*}{\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md268}{}\doxysubsubsection{\texorpdfstring{Will\+By\+Default \{\+\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}{Will\+By\+Default \{\+\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md268}
...
Represents a mock object that suppresses warnings on \href{../gmock_cook_book.md\#uninteresting-vs-unexpected}{\texttt{uninteresting calls}}. The template parameter {\ttfamily T} is any mock class, except for another {\ttfamily Nice\+Mock}, {\ttfamily \doxylink{classNaggyMock}{Naggy\+Mock}}, or {\ttfamily Strict\+Mock}.
...
Represents a mock object that generates warnings on \href{../gmock_cook_book.md\#uninteresting-vs-unexpected}{\texttt{uninteresting calls}}. The template parameter {\ttfamily T} is any mock class, except for another {\ttfamily Nice\+Mock}, {\ttfamily \doxylink{classNaggyMock}{Naggy\+Mock}}, or {\ttfamily Strict\+Mock}.

Usage of {\ttfamily \doxylink{classNaggyMock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is analogous to usage of {\ttfamily T}. {\ttfamily \doxylink{classNaggyMock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is a subclass of {\ttfamily T}, so it can be used wherever an object of type {\ttfamily T} is accepted. In addition, {\ttfamily \doxylink{classNaggyMock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} can be constructed with any arguments that a constructor of {\ttfamily T} accepts.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1NaggyMock}{testing::NaggyMock}};}
\DoxyCodeLine{...}
...
\doxylink{classMock}{Mock} objects of type {\ttfamily T} by default behave the same way as {\ttfamily \doxylink{classNaggyMock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}{}\doxysubsection{\texorpdfstring{Strict\+Mock}{Strict\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}
{\ttfamily \doxylink{classtesting_1_1StrictMock}{testing::\+\+Strict\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}

Represents a mock object that generates test failures on \href{../gmock_cook_book.md\#uninteresting-vs-unexpected}{\texttt{uninteresting calls}}. The template parameter {\ttfamily T} is any mock class, except for another {\ttfamily Nice\+Mock}, {\ttfamily \doxylink{classNaggyMock}{Naggy\+Mock}}, or {\ttfamily Strict\+Mock}.
