...
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers}{}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers}\index{Matchers Reference@{Matchers Reference}}
\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md248}%
\Hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md248}%
...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily ::\+testing} namespace unless otherwise noted.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md249}{}\doxysection{\texorpdfstring{Wildcard}{Wildcard}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md249}
...
\end{DoxyTable}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md250}{}\doxysection{\texorpdfstring{Generic Comparison}{Generic Comparison}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md250}
...
\end{DoxyTable}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md251}{}\doxysection{\texorpdfstring{String Matchers}{String Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md251}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md252}{}\doxysection{\texorpdfstring{Container Matchers}{Container Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md252}
...
\end{DoxyItemize}\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md253}{}\doxysection{\texorpdfstring{Member Matchers}{Member Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md253}
...
\end{DoxyItemize}\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md254}{}\doxysection{\texorpdfstring{Matching the Result of a Function, Functor, or Callback}{Matching the Result of a Function, Functor, or Callback}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md254}
...
\end{DoxyTable}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md255}{}\doxysection{\texorpdfstring{Pointer Matchers}{Pointer Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md255}
...
\end{DoxyTable}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md256}{}\doxysection{\texorpdfstring{Composite Matchers}{Composite Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md256}
...
\end{DoxyTable}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md257}{}\doxysection{\texorpdfstring{Adapters for Matchers}{Adapters for Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md257}
...
\end{DoxyTable}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md258}{}\doxysection{\texorpdfstring{Defining Matchers}{Defining Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md258}
