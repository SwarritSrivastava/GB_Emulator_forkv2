...
\hypertarget{md_build_2__deps_2googletest-src_2docs_2primer}{}\label{md_build_2__deps_2googletest-src_2docs_2primer}\index{GoogleTest Primer@{GoogleTest Primer}}
\label{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md221}%
\Hypertarget{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md221}%
\hypertarget{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md222}{}\doxysection{\texorpdfstring{Introduction:\+ Why Google\+Test?}{Introduction:\+ Why Google\+Test?}}\label{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md222}
...
Historically, Google\+Test started to use the term {\itshape Test Case} for grouping related tests, whereas current publications, including International Software Testing Qualifications Board (\href{http://www.istqb.org/}{\texttt{ISTQB}}) materials and various textbooks on software quality, use the term {\itshape \href{http://glossary.istqb.org/en/search/test\%20suite}{\texttt{Test Suite}}} for this.

The related term {\itshape Test}, as it is used in Google\+Test, corresponds to the term {\itshape \href{http://glossary.istqb.org/en/search/test\%20case}{\texttt{Test Case}}} of ISTQB and others.
...
\begin{DoxyTable}{3}{}{}{1}
\SetCell{bg=\tableheadbgcolor,font=\bfseries}Meaning  &\SetCell{bg=\tableheadbgcolor,font=\bfseries}Google\+Test Term  &\SetCell{bg=\tableheadbgcolor,font=\bfseries}\href{http://www.istqb.org/}{\texttt{ISTQB}} Term  \\
...
\end{DoxyTable}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md224}{}\doxysection{\texorpdfstring{Basic Concepts}{Basic Concepts}}\label{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md224}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md225}{}\doxysection{\texorpdfstring{Assertions}{Assertions}}\label{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md225}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2assertions}{Assertions Reference}{0}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md226}{}\doxysection{\texorpdfstring{Simple Tests}{Simple Tests}}\label{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md226}
To create a test:\+
...
\DoxyCodeLine{\textcolor{keyword}{class\ }\doxymbox{\hyperlink{classQueue}{Queue}}\ \{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{class\ }QueueTest\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{classtesting_1_1Test}{::testing::Test}}\ \{}
...
{\bfseries{Availability}}:\+ Linux, Windows, Mac.\hypertarget{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md227}{}\doxysection{\texorpdfstring{Invoking the Tests}{Invoking the Tests}}\label{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md227}
...
{\bfseries{Availability}}:\+ Linux, Windows, Mac.\hypertarget{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md228}{}\doxysection{\texorpdfstring{Writing the main() Function}{Writing the main() Function}}\label{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md228}
...
\{:\+ .callout .note\} NOTE:\+ {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md229}{}\doxysection{\texorpdfstring{Known Limitations}{Known Limitations}}\label{md_build_2__deps_2googletest-src_2docs_2primer_autotoc_md229}
