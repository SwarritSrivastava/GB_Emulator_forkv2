...
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md533}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md533}%
...
\{:\+ .callout .note\} {\bfseries{Note:\+}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using ::\+testing::\+\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md534}{}\doxysection{\texorpdfstring{Creating Mock Classes}{Creating Mock Classes}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md534}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md535}{}\doxysubsection{\texorpdfstring{Dealing with unprotected commas}{Dealing with unprotected commas}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md535}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md536}{}\doxysubsection{\texorpdfstring{Mocking Private or Protected Methods}{Mocking Private or Protected Methods}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md536}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md537}{}\doxysubsection{\texorpdfstring{Mocking Overloaded Methods}{Mocking Overloaded Methods}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md537}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md538}{}\doxysubsection{\texorpdfstring{Mocking Class Templates}{Mocking Class Templates}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md538}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md539}{}\doxysubsection{\texorpdfstring{Mocking Free Functions}{Mocking Free Functions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md539}
...
If you are concerned about the performance overhead incurred by virtual functions, and profiling confirms your concern, you can combine this with the recipe for \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingNonVirtualMethods}{mocking non-\/virtual methods}{2}.

Alternatively, instead of introducing a new interface, you can rewrite your code to accept a std::\+function instead of the free function, and then use \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_MockFunction}{Mock\+Function}{2} to mock the std::\+function.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md540}{}\doxysubsection{\texorpdfstring{Old-\/\+Style {\ttfamily MOCK\+\_\+\+METHODn} Macros}{Old-\/\+Style {\ttfamily MOCK\+\_\+\+METHODn} Macros}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md540}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1NiceMock}{testing::NiceMock}};}
\DoxyCodeLine{}
\DoxyCodeLine{TEST(...)\ \{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1StrictMock}{testing::StrictMock}};}
\DoxyCodeLine{}
\DoxyCodeLine{TEST(...)\ \{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md541}{}\doxysubsection{\texorpdfstring{Alternative to Mocking Concrete Classes}{Alternative to Mocking Concrete Classes}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md541}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily IOOps} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily IOOps} without mocking {\ttfamily File\+Ops}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md542}{}\doxysubsection{\texorpdfstring{Delegating Calls to a Real Object}{Delegating Calls to a Real Object}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md542}
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo::\+\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo::\+\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md544}{}\doxysection{\texorpdfstring{Using Matchers}{Using Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md544}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md545}{}\doxysubsection{\texorpdfstring{Matching Argument Values Exactly}{Matching Argument Values Exactly}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md545}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md546}{}\doxysubsection{\texorpdfstring{Using Simple Matchers}{Using Simple Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md546}
...
Sometimes, however, you know what you\textquotesingle{}re doing and want the compiler to give you some slack. One example is that you have a matcher for {\ttfamily long} and the argument you want to match is {\ttfamily int}. While the two types aren\textquotesingle{}t exactly the same, there is nothing really wrong with using a {\ttfamily \doxylink{classMatcher}{Matcher}\texorpdfstring{$<$}{<}long\texorpdfstring{$>$}{>}} to match an {\ttfamily int} -\/ after all, we can first convert the {\ttfamily int} argument to a {\ttfamily long} losslessly before giving it to the matcher.

To support this need, g\+Mock gives you the {\ttfamily Safe\+Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)} function. It casts a matcher {\ttfamily m} to type {\ttfamily \doxylink{classMatcher}{Matcher}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}. To ensure safety, g\+Mock checks that (let {\ttfamily U} be the type {\ttfamily m} accepts :\+
...
\DoxyCodeLine{\textcolor{keyword}{class\ }\doxymbox{\hyperlink{classBase}{Base}}\ \{\ ...\ \};}
\DoxyCodeLine{\textcolor{keyword}{class\ }Derived\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{classBase}{Base}}\ \{\ ...\ \};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
\DoxyCodeLine{\ \ EXPECT\_CALL(printer,\ Print(\doxymbox{\hyperlink{classMatcher}{Matcher<int>}}(Lt(5))));\ \ \textcolor{comment}{//\ void\ Print(int);}}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md547}{}\doxysubsection{\texorpdfstring{Performing Different Actions Based on the Arguments}{Performing Different Actions Based on the Arguments}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md547}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, {\ttfamily \textquotesingle{}a\textquotesingle{}} will be returned; otherwise {\ttfamily \textquotesingle{}b\textquotesingle{}} will be returned.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md548}{}\doxysubsection{\texorpdfstring{Matching Multiple Arguments as a Whole}{Matching Multiple Arguments as a Whole}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md548}
...
The expression inside {\ttfamily With()} must be a matcher of type {\ttfamily \doxylink{classMatcher}{Matcher}\texorpdfstring{$<$}{<}std::\+tuple\texorpdfstring{$<$}{<}A1, ..., An\texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>}}, where {\ttfamily A1}, ..., {\ttfamily An} are the types of the function arguments.
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args\texorpdfstring{$<$}{<}0, 1\texorpdfstring{$>$}{>}(Truly(\&My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std::\+tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md549}{}\doxysubsection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md549}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md550}{}\doxysubsection{\texorpdfstring{Using Matchers in googletest Assertions}{Using Matchers in googletest Assertions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md550}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{{\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md551}{}\doxysubsection{\texorpdfstring{Using Predicates as Matchers}{Using Predicates as Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md551}
...
Note that the predicate function /\+ functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in the statement {\ttfamily if (condition) ...}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md552}{}\doxysubsection{\texorpdfstring{Matching Arguments that Are Not Copyable}{Matching Arguments that Are Not Copyable}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md552}
...
Remember:\+ if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md553}{}\doxysubsection{\texorpdfstring{Validating a Member of an Object}{Validating a Member of an Object}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md553}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SafeMatcherCast;}
\DoxyCodeLine{}
\DoxyCodeLine{\doxymbox{\hyperlink{classMatcher}{Matcher<Foo>}}\ IsFoo(\textcolor{keyword}{const}\ Foo\&\ foo)\ \{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md554}{}\doxysubsection{\texorpdfstring{Validating the Value Pointed to by a Pointer Argument}{Validating the Value Pointed to by a Pointer Argument}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md554}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\doxymbox{\hyperlink{classtesting_1_1Matcher}{::testing::Matcher<const\ Foo\&>}}\ BarPlusBazEq(\textcolor{keywordtype}{int}\ expected\_sum)\ \{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md555}{}\doxysubsection{\texorpdfstring{Matching Containers}{Matching Containers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md555}
...
\DoxyCodeLine{\ \ \doxymbox{\hyperlink{classMatcher}{Matcher<int>}}\ expected\_vector2[]\ =\ \{1,\ Gt(2),\ \_,\ 3,\ ...\};}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md556}{}\doxysubsection{\texorpdfstring{Sharing Matchers}{Sharing Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md556}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1Matcher}{testing::Matcher}};}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ \doxymbox{\hyperlink{classMatcher}{Matcher<int>}}\ in\_range\ =\ AllOf(Gt(5),\ Le(10));}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md557}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md557}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md559}{}\doxysubsection{\texorpdfstring{Disallowing Unexpected Calls}{Disallowing Unexpected Calls}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md559}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md560}{}\doxysubsection{\texorpdfstring{Controlling When an Expectation Retires}{Controlling When an Expectation Retires}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md560}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily "{}File too large."{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md561}{}\doxysection{\texorpdfstring{Using Actions}{Using Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md561}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md562}{}\doxysubsection{\texorpdfstring{Returning References from Mock Methods}{Returning References from Mock Methods}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md562}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md563}{}\doxysubsection{\texorpdfstring{Returning Live Values from Mock Methods}{Returning Live Values from Mock Methods}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md563}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md564}{}\doxysubsection{\texorpdfstring{Combining Actions}{Combining Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md564}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md565}{}\doxysubsection{\texorpdfstring{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md565}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1DefaultValue}{testing::DefaultValue}};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md566}{}\doxysubsection{\texorpdfstring{Setting the Default Actions for a Mock Method}{Setting the Default Actions for a Mock Method}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md566}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md567}{}\doxysubsection{\texorpdfstring{Using Functions with Extra Info as Actions}{Using Functions with Extra Info as Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md567}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md568}{}\doxysubsection{\texorpdfstring{Invoking a Function/\+\+Method/\+\+Functor/\+\+Lambda/\+\+Callback Without Arguments}{Invoking a Function/\+\+Method/\+\+Functor/\+\+Lambda/\+\+Callback Without Arguments}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md568}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md569}{}\doxysubsection{\texorpdfstring{Invoking an Argument of the Mock Function}{Invoking an Argument of the Mock Function}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md569}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md570}{}\doxysubsection{\texorpdfstring{Ignoring an Action\textquotesingle{}s Result}{Ignoring an Action\textquotesingle{}s Result}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md570}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md571}{}\doxysubsection{\texorpdfstring{Ignoring Arguments in Action Functions}{Ignoring Arguments in Action Functions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md571}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md572}{}\doxysubsection{\texorpdfstring{Sharing Actions}{Sharing Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md572}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1Action}{testing::Action}};}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::DoAll;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Return;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SetArgPointee;}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ \doxymbox{\hyperlink{classAction}{Action}}<bool(\textcolor{keywordtype}{int}*)>\ set\_flag\ =\ DoAll(SetArgPointee<0>(5),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Return(\textcolor{keyword}{true}));}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1Action}{testing::Action}};}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ \doxymbox{\hyperlink{classAction}{Action}}<int()>\ increment\ =\ IncrementCounter(0);}
\DoxyCodeLine{\ \ EXPECT\_CALL(foo,\ DoThis())}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md573}{}\doxysubsection{\texorpdfstring{Testing Asynchronous Behavior}{Testing Asynchronous Behavior}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md573}
...
\{:\+ .callout .note\} Note:\+ this example has a downside:\+ namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md574}{}\doxysection{\texorpdfstring{Misc Recipes on Using g\+Mock}{Misc Recipes on Using g\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md574}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md575}{}\doxysubsection{\texorpdfstring{Mocking Methods That Use Move-\/\+Only Types}{Mocking Methods That Use Move-\/\+Only Types}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md575}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::IsNull;}
\DoxyCodeLine{...}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md576}{}\doxysubsection{\texorpdfstring{Making the Compilation Faster}{Making the Compilation Faster}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md576}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md577}{}\doxysubsection{\texorpdfstring{Forcing a Verification}{Forcing a Verification}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md577}
...
Also, remember that {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md579}{}\doxysubsection{\texorpdfstring{Controlling How Much Information g\+Mock Prints}{Controlling How Much Information g\+Mock Prints}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md579}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md580}{}\doxysubsection{\texorpdfstring{Gaining Super Vision into Mock Calls}{Gaining Super Vision into Mock Calls}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md580}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md581}{}\doxysubsection{\texorpdfstring{Running Tests in Emacs}{Running Tests in Emacs}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md581}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/\+{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md582}{}\doxysection{\texorpdfstring{Extending g\+Mock}{Extending g\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md582}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\doxymbox{\hyperlink{classMatcher}{Matcher<int>}}\ DivisibleBy7()\ \{}
...
\{:\+ .callout .tip\} Tip:\+ for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener\texorpdfstring{$\ast$}{*}} instead of {\ttfamily std::\+ostream\texorpdfstring{$\ast$}{*}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md585}{}\doxysubsection{\texorpdfstring{Writing New Polymorphic Matchers}{Writing New Polymorphic Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md585}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md586}{}\doxysubsection{\texorpdfstring{Legacy Matcher Implementation}{Legacy Matcher Implementation}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md586}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md587}{}\doxysubsection{\texorpdfstring{Writing New Cardinalities}{Writing New Cardinalities}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md587}
...
More generally, to use with a mock function whose signature is {\ttfamily R(\+Args...)} the object can be anything convertible to {\ttfamily Once\+Action\texorpdfstring{$<$}{<}R(\+Args...)\texorpdfstring{$>$}{>}} or {\ttfamily \doxylink{classAction}{Action}\texorpdfstring{$<$}{<}R(\+Args...)}\texorpdfstring{$>$}{>}. The difference between the two is that {\ttfamily Once\+Action} has weaker requirements ({\ttfamily \doxylink{classAction}{Action}} requires a copy-\/constructible input that can be called repeatedly whereas {\ttfamily Once\+Action} requires only move-\/constructible and supports {\ttfamily \&\&}-\/qualified call operators), but can be used only with {\ttfamily Will\+Once}. {\ttfamily Once\+Action} is typically relevant only when supporting move-\/only types or actions that want a type-\/system guarantee that they will be called at most once.

Typically the {\ttfamily Once\+Action} and {\ttfamily \doxylink{classAction}{Action}} templates need not be referenced directly in your actions:\+ a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily gmock-\/actions.\+h} for examples.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md588}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based Actions}{Legacy macro-\/based Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md588}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md589}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based parameterized Actions}{Legacy macro-\/based parameterized Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md589}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md590}{}\doxysubsection{\texorpdfstring{Restricting the Type of an Argument or Parameter in an ACTION}{Restricting the Type of an Argument or Parameter in an ACTION}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md590}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md591}{}\doxysubsection{\texorpdfstring{Writing New Action Templates Quickly}{Writing New Action Templates Quickly}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md591}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md592}{}\doxysubsection{\texorpdfstring{Using the ACTION Object\textquotesingle{}s Type}{Using the ACTION Object\textquotesingle{}s Type}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md592}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1Action}{testing::Action}};}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1ActionInterface}{testing::ActionInterface}};}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\doxymbox{\hyperlink{classAction}{Action<IncrementMethod>}}\ IncrementArgument()\ \{}
...
\DoxyCodeLine{\doxymbox{\hyperlink{classtesting_1_1PolymorphicAction}{PolymorphicAction<Impl>}}\ MakePolymorphicAction(\textcolor{keyword}{const}\ Impl\&\ impl);}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1PolymorphicAction}{testing::PolymorphicAction}};}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md593}{}\doxysubsection{\texorpdfstring{Teaching g\+Mock How to Print Your Values}{Teaching g\+Mock How to Print Your Values}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md593}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md594}{}\doxysection{\texorpdfstring{Useful Mocks Created Using g\+Mock}{Useful Mocks Created Using g\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md594}
