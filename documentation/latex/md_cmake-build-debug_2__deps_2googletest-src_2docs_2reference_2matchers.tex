...
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md663}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md663}%
...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily ::\+testing} namespace unless otherwise noted.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md664}{}\doxysection{\texorpdfstring{Wildcard}{Wildcard}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md664}

\begin{DoxyTable}{2}{}{}{1}
\SetCell{bg=\tableheadbgcolor,font=\bfseries}\doxylink{classMatcher}{Matcher}  &\SetCell{bg=\tableheadbgcolor,font=\bfseries}Description  \\
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md665}{}\doxysection{\texorpdfstring{Generic Comparison}{Generic Comparison}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md665}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md666}{}\doxysection{\texorpdfstring{String Matchers}{String Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md666}
...
{\ttfamily When\+Base64\+Unescaped(m)}  &{\ttfamily argument} is a base-\/64 escaped string whose unescaped string matches {\ttfamily m}. The web-\/safe format from \href{https://www.rfc-editor.org/rfc/rfc4648\#section-5}{\texttt{RFC 4648}} is supported.  \\
\end{DoxyTable}


{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md667}{}\doxysection{\texorpdfstring{Container Matchers}{Container Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md667}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md668}{}\doxysection{\texorpdfstring{Member Matchers}{Member Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md668}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md669}{}\doxysection{\texorpdfstring{Matching the Result of a Function, Functor, or Callback}{Matching the Result of a Function, Functor, or Callback}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md669}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md670}{}\doxysection{\texorpdfstring{Pointer Matchers}{Pointer Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md670}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md671}{}\doxysection{\texorpdfstring{Composite Matchers}{Composite Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md671}
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md672}{}\doxysection{\texorpdfstring{Adapters for Matchers}{Adapters for Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md672}

\begin{DoxyTable}{2}{}{}{1}
\SetCell{bg=\tableheadbgcolor,font=\bfseries}\doxylink{classMatcher}{Matcher}  &\SetCell{bg=\tableheadbgcolor,font=\bfseries}Description  \\
{\ttfamily Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}  &casts matcher {\ttfamily m} to type {\ttfamily \doxylink{classMatcher}{Matcher}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.  \\
{\ttfamily Safe\+Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}  &\href{../gmock_cook_book.md\#SafeMatcherCast}{\texttt{safely casts}} matcher {\ttfamily m} to type {\ttfamily \doxylink{classMatcher}{Matcher}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.  \\
...
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md673}{}\doxysection{\texorpdfstring{Defining Matchers}{Defining Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md673}
