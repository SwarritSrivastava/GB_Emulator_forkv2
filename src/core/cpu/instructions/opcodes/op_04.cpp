...
{
    cpu.reg(ProcessingUnit::Register::C) = cpu.reg(ProcessingUnit::Register::B);

    return totalMachineCycles(1);
}
int op_ld_c_c(ProcessingUnit& cpu, MMU& mmu) // 0x49
{
    cpu.reg(ProcessingUnit::Register::C) = cpu.reg(ProcessingUnit::Register::C);

    return totalMachineCycles(1);
}
int op_ld_c_d(ProcessingUnit& cpu, MMU& mmu) // 0x4A
{
    cpu.reg(ProcessingUnit::Register::C) = cpu.reg(ProcessingUnit::Register::D);

    return totalMachineCycles(1);
}
int op_ld_c_e(ProcessingUnit& cpu, MMU& mmu) // 0x4B
{
    cpu.reg(ProcessingUnit::Register::C) = cpu.reg(ProcessingUnit::Register::E);

    return totalMachineCycles(1);
}
int op_ld_c_h(ProcessingUnit& cpu, MMU& mmu) // 0x4C
{
    cpu.reg(ProcessingUnit::Register::C) = cpu.reg(ProcessingUnit::Register::H);

    return totalMachineCycles(1);
}
int op_ld_c_l(ProcessingUnit& cpu, MMU& mmu) // 0x4D
{
    cpu.reg(ProcessingUnit::Register::C) = cpu.reg(ProcessingUnit::Register::L);

    return totalMachineCycles(1);
}
int op_ld_c_hl(ProcessingUnit& cpu, MMU& mmu) // 0x4E
{
    cpu.reg(ProcessingUnit::Register::C) = mmu.read(cpu.get_hl());
